            ...
            <article className="wetter7t">
                ...
                {props.data.daily.map((dailyweather, key) =>
                    <div className="einTag" key={key}>
                        ...
                        <div className="tagTief tempGrad" id="tagTief0">{Math.round(dailyweather.temp.min)}°</div>
                        <div className="tagHoch tempGrad" id="tagHoch0">{Math.round(dailyweather.temp.max)}°</div>
                    </div>)}
            </article>
        </section>
    )
